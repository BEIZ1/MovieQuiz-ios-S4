...
class MoviesLoaderTests: XCTestCase {
    ...
    struct StubNetworkClient: NetworkRouting {
        ...
        enum TestError: Error { //теcтовая ошибка
            case test
        }
    ...
    func testSuccessLoading() throws {
        // Given
        let stubNetworkClientt = StubNetworkClient(emulateError: false) // говорим, что не хотим эмулировать ошибку
        let loader = MoviesLoader(networkClient: stubNetworkClientt)
    ...
    func testFailureLoading() throws {
        // Given
        let stubNetworkClientt = StubNetworkClient(emulateError: true)
        let loader = MoviesLoader(networkClient: stubNetworkClientt)
